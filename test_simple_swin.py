...
def test_simple(args):
    ...
    encoder_path = os.path.join(model_path, "swin_encoder.pth")
    depth_decoder_path = os.path.join(model_path, "swin_decoder.pth")
    ...
    with torch.no_grad():
        for idx, image_path in enumerate(paths):
            ...
            name_dest_im = os.path.join(
                output_directory, "{}_swin_disp.jpeg".format(output_name))
